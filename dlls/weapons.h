...
extern void DecalGunshot( TraceResult *pTrace, int iBulletType, Vector vecSrc = g_vecZero, Vector vecEnd = g_vecZero );
extern void SpawnBlood(Vector vecSpot, int bloodColor, float flDamage);
extern int DamageDecal( CBaseEntity *pEntity, int bitsDamageType, Vector vecSrc = 0 , Vector vecEnd = 0  );
